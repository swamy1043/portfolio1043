...
window.addEventListener('scroll', () => {
    ...
    if (video) {
        ...
        video.style.transform = `translateX(-50%) translateY(${rate}px)`;
    }
});
...
function checkMobile() {
    if (window.innerWidth <= 768) {
        ...
        if (video) {
            ...
            document.querySelector('.video-background').style.background = 'linear-gradient(45deg, #667eea, #764ba2)';
        }
    }
}
...
// Portfolio website initialization
